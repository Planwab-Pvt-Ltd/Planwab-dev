...
export default function HomePageWrapper() {
  ...
  const currentTheme =
    categoryThemes[activeCategory] || categoryThemes?.Default;
    ...
    <>
      <main className="relative w-full overflow-x-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(125% 125% at 50% 10%, #fff 40%, #fef3c7 100%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(125% 125% at 50% 10%, #0d1117 40%, #2c1a01 100%)",
          }}
        />
