...
const vendorsData = [
    ...
    { id: 2, type: 'Photographer', name: 'Rohan Mehta', specialty: 'Candid Wedding Photographer', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&q=80', rating: 4.9, experience: 8, verified: true, portfolio: 200 },
    { id: 3, type: 'Decorator', name: 'Bloom & Petal', style: 'Modern & Minimalist', image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&q=80', services: ['Floral Design', 'Lighting', 'Theming'], verified: true, projects: 120 },
    { id: 4, type: 'Venue', name: 'Coastal Dreams Resort', location: 'Goa', image: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&q=80', capacity: 200, price: '3,50,000', rating: 4.8, verified: true, bookings: 85 },
    { id: 5, type: 'Planner', name: 'Priya Sharma', experience: '10 Years', image: 'https://images.unsplash.com/photo-1494790108755-2616b332c913?w=800&q=80', tagline: 'Flawless execution, unforgettable moments.', verified: true, events: 300 },
    { id: 6, type: 'Photographer', name: 'Frames & Vows', specialty: 'Fine Art Storytelling', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=800&q=80', rating: 5.0, experience: 12, verified: true, portfolio: 350 },
    { id: 7, type: 'Decorator', name: 'The Gilded Lily', style: 'Royal & Opulent', image: 'https://images.unsplash.com/photo-1464207687429-7505649dae38?w=800&q=80', services: ['Luxury Drapery', 'Chandeliers', 'Floral'], verified: true, projects: 95 },
    { id: 8, type: 'Planner', name: 'The Event Architects', experience: '15 Years', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=800&q=80', tagline: 'Your vision, our passion.', verified: true, events: 450 },
];

const filters = [
    { label: 'All', icon: <Sparkles size={18} />, gradient: 'from-amber-400 to-yellow-500' },
    { label: 'Venues', icon: <MapPin size={18} />, gradient: 'from-emerald-400 to-teal-500' },
    { label: 'Photographers', icon: <Camera size={18} />, gradient: 'from-blue-400 to-indigo-500' },
    { label: 'Decorators', icon: <Brush size={18} />, gradient: 'from-rose-400 to-pink-500' },
    { label: 'Planners', icon: <UserCheck size={18} />, gradient: 'from-amber-400 to-orange-500' }
];
...
export const DecoratorCard = ({ vendor }) => (
    <motion.div
        ...
        exit={{ opacity: 0, y: -30, scale: 0.95 }}
        transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
        className="group bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-amber-100/50 h-[480px] flex flex-col"
    >
        <div className="p-6 flex-1 flex flex-col">
        ...
        <section className="py-24 bg-gradient-to-br from-amber-50/30 via-white to-yellow-50/20 relative overflow-hidden">
            ...
            >
                <motion.div variants={itemVariants} className="text-center max-w-4xl mx-auto mb-16">
                    ...
                    >
                        Connect with our carefully curated network of top-tier vendors who will bring your dream event to life with unmatched expertise and creativity.
                    </motion.p>
                </motion.div>
