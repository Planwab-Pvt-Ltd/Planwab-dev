...
import {
  ...
  Phone, Mail, Calendar, DollarSign, Share2, Check,
  MapIcon, Wifi, Car, Music, Wind, Camera, User, Shield,
  Award, Zap, Building2, Home, Utensils, Crown,
  MessageCircle, Copy, Facebook, Twitter, X,
  ChevronUp, Grid, List, Eye,
  ThumbsUp, ArrowLeft, ExternalLink
} from "lucide-react";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                {[1, 2].map((col) => (
                  <div key={col} className="space-y-4">
                    ...
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="h-12 w-full bg-gray-100 dark:bg-gray-700/50 rounded-lg animate-pulse" />
                    ))}
                  </div>
                ))}
              </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="flex space-x-1 mt-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <div key={star} className="h-4 w-4 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
                      ))}
                    </div>
                  </div>
                </div>
