...
const CAROUSEL_HEADER_IMAGES = {
  events: {
    featured: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771594539/FeaturedVendorsEventsDesktopCarHeaderCard_efnzy5.png",
    planners: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771594691/PlannersEventsDesktopCarHeaderCard_g7uva8.png",
    photographers: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771594540/PhotoGrapherEventsDesktopCarHeaderCard_dhs5tk.png",
    venues: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771594540/VenuesEventsDesktopCarHeaderCard_itlslv.webp",
    makeup: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771594540/MakeUpEventsDesktopCarHeaderCard_z8xdef.png",
    catering: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772105015/CateringVendorsEventsDesktopCarHeaderCard_wdqf9t.png",
    djs: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772105012/DjsEventsDesktopCarHeaderCard_oyj1cv.png",
  ...
  wedding: {
    featured: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771591300/FeaturedVendorsWeddingDesktopCarHeaderCard_ycnu2l.png",
    planners: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771517863/plannerWeddingDesktopCarHeaderCard_p38nbw.png",
    photographers: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771591300/PhotoGrapherWeddingDesktopCarHeaderCard_vqbl4p.png",
    venues: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771591300/VenuesWeddingDesktopCarHeaderCard_n3iamk.webp",
    makeup: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771591300/MakeUpWeddingDesktopCarHeaderCard_bmnfxf.png",
    catering: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104867/CateringVendorsWeddingDesktopCarHeaderCard_cvi6cd.png",
    decorators: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104866/DecorsWeddingDesktopCarHeaderCard_odfjpx.webp",
    florists: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104865/floristsWeddingDesktopCarHeaderCard_jfx1fu.png",
    invitations: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772105152/InvitationsWeddingDesktopCarHeaderCard_cxalqt.png",
    mehendi: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772105477/MehendiWeddingDesktopCarHeaderCard_doklaf.png",
    cardsWithBanner1: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771597043/WeddingCWB_g5s05q.webp",
  },
  anniversary: {
    featured: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595640/FeaturedVendorsAnniversaryDesktopCarHeaderCard_ah2nd6.png",
    planners: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595655/PlannersAnniversaryDesktopCarHeaderCard_hasn0v.png",
    photographers: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595642/PhotoGrapherAnniversaryDesktopCarHeaderCard_pvczsj.png",
    venues: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595641/VenuesAnniversaryDesktopCarHeaderCard_r5eci4.webp",
    makeup: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595640/MakeUpAnniversaryDesktopCarHeaderCard_ei91ro.png",
    catering: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104702/CateringVendorsAnniversaryDesktopCarHeaderCard_k5kwjl.png",
    decorators: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104711/DecorsAnniversaryDesktopCarHeaderCard_jgi3d7.webp",
    florists: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104741/floristsAnniversaryDesktopCarHeaderCard_n5i10s.png",
    cardsWithBanner1: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771597071/AnniversaryCWB_h9zf4i.webp",
  },
  birthday: {
    featured: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595843/FeaturedVendorsBirthdayDesktopCarHeaderCard_txxlmq.png",
    planners: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595857/PlannersBirthdayDesktopCarHeaderCard_aw3owa.png",
    photographers: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595846/PhotoGrapherBirthdayDesktopCarHeaderCard_pyxcu6.png",
    venues: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595844/VenuesBirthdayDesktopCarHeaderCard_y7mr16.webp",
    makeup: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1771595844/MakeUpBirthdayDesktopCarHeaderCard_yqp2u4.png",
    cakes: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104510/CakesBirthdayDesktopCarHeaderCard_xcyw37.png",
    decorators: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104510/DecorsBirthdayDesktopCarHeaderCard_f7hvtq.webp",
    entertainment: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104511/EntertainmentGrapherBirthdayDesktopCarHeaderCard_zjvbai.png",
    catering: "https://res.cloudinary.com/dhkkvo36x/image/upload/v1772104510/CateringVendorsBirthdayDesktopCarHeaderCard_xlu8w4.png",
