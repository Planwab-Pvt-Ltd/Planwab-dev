  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-white dark:bg-black">
      ...
      <div className="block lg:hidden min-h-screen relative">
        {/* Mobile Background: Enhanced Gradient for premium App feel */}
        ...
        <div className="relative z-10 flex flex-col min-h-screen p-6 justify-between">
          ...
          >
            {/* Logo Container with gradient ring/shadow */}
            ...
            <p className="text-base text-gray-600 dark:text-gray-300 mt-2 font-medium">
              Sign in to continue to PlanWAB
            </p>
          </motion.div>
            ...
            <div className="w-full max-w-sm">
              {!isLoaded ? (
                <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-md rounded-3xl shadow-xl p-8 flex flex-col items-center justify-center min-h-[300px] border border-white/50 dark:border-gray-800/50">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Loading secure login...</p>
                </div>
              ) : (
                // Clerk Component - Styled to blend seamlessly
                <div className="signin-wrapper-mobile">
                  <SignIn
                    appearance={{
                      elements: {
                        rootBox: "w-full",
                        // Make the card transparent so it sits on our page background
                        card: "shadow-none border-none bg-transparent w-full p-0",
                        headerTitle: "hidden",
                        headerSubtitle: "hidden",
                        // Style the input fields for mobile touch
                        formFieldInput:
                      ...
                      layout: {
                        shimmer: false, // Disable Clerk's loading shimmer as we have our own
                      },
                    }}
                  />
                </div>
