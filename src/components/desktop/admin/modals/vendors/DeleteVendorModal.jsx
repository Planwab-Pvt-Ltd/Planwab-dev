...
const DeleteVendorModal = ({ vendor, onClose, onConfirm }) => (
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                        <p className="text-sm text-gray-500">
                            Are you sure you want to delete <span className="font-semibold">{vendor.name}</span>? This action cannot be undone.
                        </p>
                    </div>
                </div>
            </div>
